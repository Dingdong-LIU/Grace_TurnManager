    ...
    def __applyPolicy(self):
        ...
        if self.__config_data["TM"]["Debug"]["enable_prog_part"]:
            ...
            if progressive_actions is not None:
                ...
                utterance = ""
                if progressive_actions.get("content"):
                    utterance = progressive_actions.get("content", {}).get("utterance", "")
                self.shared_data.change_previous_question(utterance)
    ...
    def __mergeExec(self, decisions):
        ...
        if "prog_act" in decisions:
            ...
            self.__gen_bc_action(
                ...
                decisions["inst_act"]["sentiment_bc_action"].get("hum", None)
            )
